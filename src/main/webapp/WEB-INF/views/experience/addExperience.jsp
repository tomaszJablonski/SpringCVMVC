                    ...
                    <div class="container-fluid">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control" type="text" name="nameOfTheJob" placeholder="enter text here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-2 col-form-label">Main Task</label>
                                                <div class="col-10">
                                                    <input class="form-control" type="text" name="mainTask"  placeholder="enter text here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                ...
                                <textarea class="form-control" rows="5" id="start" name="description"
                                          placeholder="write here about your job ..."></textarea>
                                                </div>
                                            </div>
