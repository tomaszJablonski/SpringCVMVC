...
<%@include file="../../dynamic/head.jspf" %>
    <body id="page-top">
        ...
        <div class="container-fluid p-0">
            ...
            <form method="post" action="/editWorkflow/${workflow.id}" >

                <section class="resume-section" id="workflow">
                <div class="resume-section-content">
                    <h2 class="mb-5">Workflow</h2>
                    <!-- Begin Page Content -->
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <div class="form-group row">
                                                <label for="start" class="col-2 col-form-label">Edit Workflow</label>
                                                <div class="col-10">
                                <textarea class="form-control" rows="5" id="start" name="abilities"
                                          placeholder="write here ...">${workflow.abilities}</textarea>
                                                </div>
                                            </div>
